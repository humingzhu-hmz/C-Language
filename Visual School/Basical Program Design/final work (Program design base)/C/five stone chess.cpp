...
int strategy2()
{
	int score = -1;/*������������score < maxscore(x,
	y)��ֻ��һ�����ӵ�ʱ����Զ�᲻����,��Ϊscore=0,
	����maxscore��Զ����0����currentxһֱû�и���,����ʱ�ҵ�
	currentx�����µ����ӵ�������һ�µľ͵����˽����������,������
	���ڸ�λ���ʼ�Ǳ�ռ�õ�,��������ʧ��,������case0��������strategy��Ȼ������
	���Ի��������case0,֮�����л�����human��,���Ըĳ�-1,������·����,���������ĳ�
	<=maxscore,���������ռ����,���ϵ�д���е��˷�*/
			...
			if (mode == 2)
			{
					...
					//when the distance of time more than set value.incomplment strategy.
				{
					...
					if (Key.space)
					{
						...
						while (true)
						{
							//getmessage(&msg);�����Ǹ������,����ȴ��Ұ���Ȼ�����Ƿ�����Ϣ,�Һ�������
							//peekspecific,����ʱ��Ϣ�Ѿ�ȡ������,����key->space���Ұ��µļ�����false,������ѭ����
							//����ʹ��peek��get���ܻ���һ����.����������getmessage �ж�msg.vkcodeҲ����,�������û����Ա���cpu��ת
							Peekspecific(&Key);
							if (Key.esc)
							{
								restartgame();
