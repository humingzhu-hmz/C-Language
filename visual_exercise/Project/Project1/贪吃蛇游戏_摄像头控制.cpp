...
//} Direction;
//
//// 坐标结构体（重命名为GamePoint避免与OpenCV的Point冲突）
//typedef struct {
//    int x;
//    int y;
//} GamePoint;
...
//
//// 检查点是否在蛇身上
//int isSnakeBody(SnakeGame* game, GamePoint p) {
//    SnakeNode* current = game->head;
//    while (current != NULL) {
...
//
//// 检查碰撞
//int checkCollision(SnakeGame* game, GamePoint head) {
//    // 检查墙壁碰撞
...
//    if (game->direction == NONE || game->head == NULL) {
//        return;
//    }
//
//    // 计算新头部位置
...
//        printf("Please check:\n");
//        printf("1. Camera is connected\n");
//        printf("2. No other program is using the camera\n");
//        printf("3. Camera drivers are installed\n");
//        if (cap != NULL) {
//            delete cap;
//            cap = NULL;
//        }
...
//    // 红色范围（需要两个范围，因为红色在HSV中跨越0度）
//    lowerBound = Scalar(0, 50, 50);   // 红色下限
//    upperBound = Scalar(10, 255, 255); // 红色上限
//
//    printf("Camera initialized successfully!\n");
//    printf("Tracking color: Red\n");
//    printf("Tip: Show a red object (ball, glove, etc.) to the camera\n");
//
//    return 1;
//}
//
...
//    if (contours.empty()) {
//        // 显示原始图像（即使没有检测到物体）
//        imshow("Hand Tracking - No object detected", frame);
//        waitKey(1);
//        return NONE;
//    }
//
...
//        imshow("Hand Tracking - Object too small", frame);
//        waitKey(1);
//        return NONE;
//    }
//
...
//
//    GamePoint currentHandPos = { cx, cy };
//
//    // 在图像上绘制追踪点和轮廓
//    circle(frame, cv::Point(cx, cy), 10, Scalar(0, 255, 0), -1);
//    drawContours(frame, contours, maxIdx, Scalar(255, 0, 0), 2);
//
//    // 显示追踪窗口
//    putText(frame, "Move object to control snake", cv::Point(10, 30),
...
//    int choice;
//    if (scanf("%d", &choice) != 1) {
//        printf("Invalid input! Using keyboard mode.\n");
//        choice = 1;
//    }
//
//    int useCamera = 0;
...
//            printf("Switching to keyboard control mode.\n");
...
//            printf("\nCamera ready!\n");
//            printf("Instructions:\n");
//            printf("- Show a RED object (ball, glove, marker, etc.) to the camera\n");
